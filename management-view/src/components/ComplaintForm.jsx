    ...
    <form className="complaint-form section-card" onSubmit={handleSubmit}>
      ...
      {submitting ? (
        <div style={{ textAlign: 'center', padding: '2em' }}>
          <span style={{ fontSize: '1.25em', color: '#e11d48', fontWeight: 600 }}>Submitting your complaint...</span>
          <div className="loader" style={{ margin: '1em auto', width: '40px', height: '40px', border: '4px solid #e11d48', borderTop: '4px solid #fff', borderRadius: '50%', animation: 'spin 1s linear infinite' }} />
        </div>
      ) : (
        <>
